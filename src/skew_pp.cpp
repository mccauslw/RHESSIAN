...
{
  NumericVector log_f(skew_eval_c(mode, h, mu, omega, z));
  return log_f;
}
...
{
  NumericVector draws(skew_draw_c(mode, h, mu, omega, n_draws));
  return draws;
}

/*** R
skew_eval_cpp(5, c(0, 0.4, 0.01, 0, 0), 4, 1.0, seq(0, 10, by=0.1))
skew_draw_cpp(5, c(0, 0.4, 0.01, 0, 0), 4, 1.0, 1000)
*/
