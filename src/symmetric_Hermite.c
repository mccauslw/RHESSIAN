...
{
    int k;
    Symmetric_Hermite *sh = (Symmetric_Hermite *) malloc(sizeof(Symmetric_Hermite));
    sh->max_K = max_K;
    sh->max_n_reject = max_n_reject;
    sh->chi2_const = (double *) malloc(max_K * sizeof(double));
    sh->cum_w = (double *) malloc(max_K * sizeof(double));
    sh->coeff = (double *) malloc(max_K * sizeof(double));
    sh->neg_coeff = (double *) malloc(max_K * sizeof(double));
